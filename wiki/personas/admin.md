...
Workspace owners. The person who set up Pulse HR for the org. Often also wears another hat (founder, ops lead, IT lead).

## Theme

Electric cyan accent (`#6fd8ff`) on a cool-dark surface. Signals "system."
...
- "I need to see what HR sees right now." → role-override switcher (see [[Role Themes]]) lets admins view as another role.
