...
| ------ | ------------------------------------------ | --------------------------------------------- | ----------- |
| EX-01  | Hero reel — "A day at Pulse" (12s, 1280×720) | `apps/marketing/studio/output/desktop.mp4`                | Ready       |
| EX-02  | Social vertical of EX-01 (9:16)              | `apps/marketing/studio/output/social-vertical.mp4`        | Ready       |
...
| EX-08  | Remotion video pipeline                    | `apps/marketing/studio/`                                  | Usable      |
...
| `docs/brand/reels/001-open-source/`    | Single-reel render folder. Video masters now live under `apps/marketing/studio/output/` and ship to `apps/marketing/public/studio/`. |
