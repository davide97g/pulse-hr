...
| Reel (9:16 video)  | 1            | 12–20 s. Screen capture with burned-in Geist captions. Driven off `apps/marketing/studio/` output.  |
...
- Hero reel re-rendered off `apps/marketing/studio/` and published.
...
| Reel production (`apps/marketing/studio/`)   | Davide   | Niccolò  |
...
- `apps/marketing/studio/` — the Remotion-based video pipeline that turns brand primitives into motion.
