...
// gtag from GA snippet — overloads are huge; we only use a few calls.
...
/**
 * Synchronous: dataLayer, gtag stub, consent default, then load gtag.js. Run from
 * the module entry in `index.html` before the main React bundle.
 */
export function initGoogleAnalytics(): void {
  ...
  // `...args` satisifies Gtag; body uses `arguments` to match the official gtag.js stub.
