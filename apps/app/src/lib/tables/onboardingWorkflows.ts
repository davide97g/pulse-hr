...
import { onboardingWorkflows, __setOnboardingWorkflows, type OnboardingWorkflow } from "@/lib/mock-data";
...
export const onboardingWorkflowsTable = createTable<OnboardingWorkflow>("onboardingWorkflows", seed, "ow");
