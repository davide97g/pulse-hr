    ...
    <div className="room-dark min-h-dvh flex flex-col bg-[#0a0907] text-[var(--paper)] pl-safe pr-safe">
      ...
      >
        <div className="h-14 flex items-center px-4 md:px-6 gap-2 md:gap-3">
          <a
            href={APP_URL}
            className="inline-flex items-center gap-1.5 text-[10px] tracking-[0.12em] uppercase font-mono text-white/55 hover:text-white press-scale tap-target no-tap-highlight h-9 px-1"
            title="Back to Pulse"
          >
          ...
          {user && (
            <div className="flex items-center gap-2">
              ...
              <button
                ...
                className="h-9 w-9 md:w-auto md:h-8 md:px-2.5 inline-flex items-center justify-center gap-1.5 rounded-md border border-white/10 bg-transparent hover:bg-white/5 text-[11px] text-white/60 tap-target no-tap-highlight"
                title="Sign out"
                aria-label="Sign out"
              >
